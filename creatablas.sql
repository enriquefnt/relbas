...
CREATE TABLE `tablaimcpericefa` (
  `IdImc` int(3) DEFAULT NULL,
  `IdMes` int(3) DEFAULT NULL,
  `Lio` decimal(6,4) DEFAULT NULL,
  `Mio` decimal(6,4) DEFAULT NULL,
  `Sio` decimal(6,5) DEFAULT NULL,
  `SD4nio` decimal(5,3) DEFAULT NULL,
  `SD3nio` decimal(5,3) DEFAULT NULL,
  `SD2nio` decimal(5,3) DEFAULT NULL,
  `SD1nio` decimal(5,3) DEFAULT NULL,
  `SD0io` decimal(5,3) DEFAULT NULL,
  `SD1io` decimal(5,3) DEFAULT NULL,
  `SD2io` decimal(5,3) DEFAULT NULL,
  `SD3io` decimal(5,3) DEFAULT NULL,
  `SD4io` decimal(5,3) DEFAULT NULL,
  `Lia` decimal(6,4) DEFAULT NULL,
  `Mia` decimal(6,5) DEFAULT NULL,
  `Sia` decimal(6,5) DEFAULT NULL,
  `SD4nia` decimal(5,3) DEFAULT NULL,
  `SD3nia` decimal(5,3) DEFAULT NULL,
  `SD2nia` decimal(5,3) DEFAULT NULL,
  `SD1nia` decimal(5,3) DEFAULT NULL,
  `SD0ia` decimal(5,3) DEFAULT NULL,
  `SD1ia` decimal(5,3) DEFAULT NULL,
  `SD2ia` decimal(5,3) DEFAULT NULL,
  `SD3ia` decimal(5,3) DEFAULT NULL,
  `SD4ia` decimal(5,3) DEFAULT NULL,
  `Lpo` decimal(2,1) DEFAULT NULL,
  `"Mpo"` decimal(6,4) DEFAULT NULL,
  `Spo` decimal(6,5) DEFAULT NULL,
  `Sdpo` decimal(5,4) DEFAULT NULL,
  `SD3npo` decimal(3,1) DEFAULT NULL,
  `SD2npo` decimal(3,1) DEFAULT NULL,
  `SD1npo` decimal(3,1) DEFAULT NULL,
  `SD0po` decimal(3,1) DEFAULT NULL,
  `SD1po` decimal(3,1) DEFAULT NULL,
  `SD2po` decimal(3,1) DEFAULT NULL,
  `SD3po` decimal(3,1) DEFAULT NULL,
  `Lpa` decimal(2,1) DEFAULT NULL,
  `Mpa` decimal(6,4) DEFAULT NULL,
  `Spa` decimal(6,5) DEFAULT NULL,
  `Sdpa` decimal(5,4) DEFAULT NULL,
  `SD3npa` decimal(3,1) DEFAULT NULL,
  `SD2npa` decimal(3,1) DEFAULT NULL,
  `SD1npa` decimal(3,1) DEFAULT NULL,
  `SD0pa` decimal(3,1) DEFAULT NULL,
  `SD1pa` decimal(3,1) DEFAULT NULL,
  `SD2pa` decimal(3,1) DEFAULT NULL,
  `SD3pa` decimal(3,1) DEFAULT NULL
